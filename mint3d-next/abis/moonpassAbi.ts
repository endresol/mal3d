export const moonpassAbi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_pass_type", type: "uint256" },
    ],
    name: "get_pass",
    outputs: [],
  ...
  {
    inputs: [{ internalType: "uint256", name: "_pass_type", type: "uint256" }],
    name: "myBalance",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  ...
  {
    inputs: [{ internalType: "address", name: "my_address", type: "address" }],
  ...
  {
    inputs: [
      { internalType: "address payable", name: "to_address", type: "address" },
    ],
    name: "withdraw",
    outputs: [{ internalType: "bool", name: "", type: "bool" }],
    stateMutability: "nonpayable",
